...
<p align="center">
    ...
    <a href="https://github.com/Screenly/Browser-Extension/actions/workflows/lint-and-format.yaml?query=branch%3Amaster">
        <img alt="GitHub Actions Workflow Status" src="https://img.shields.io/github/actions/workflow/status/Screenly/Browser-Extension/lint-and-format.yaml?branch=master&style=for-the-badge&label=ESLint">
    </a>
